...
const BottomNavigation = () => {
  return (
    <nav className="sticky bottom-0 left-0 right-0 bg-white border rounded-t-xl shadow-md mx-1 z-10">
      <div className="flex w-full justify-around py-4">
        <div className="flex flex-col text-center space-y-[2px]">
          <Link href={"/watch"}>
            <span className="flex w-full justify-center hover:-translate-y-2 hover:cursor-pointer transition duration-300 hover:text-teal-500/70">
              <svg
